...
void (*var_sg_Graphics_DrawThickLine)(color clr, float xPosStart, float yPosStart, float xPosEnd, float yPosEnd, float width);
void sg_Graphics_DrawThickLine(color clr, float xPosStart, float yPosStart, float xPosEnd, float yPosEnd, float width)
{
	var_sg_Graphics_DrawThickLine(clr,xPosStart,yPosStart,xPosEnd,yPosEnd,width);
}
...
struct DLLLoader
{
	DLLLoader()
	{
		...
		var_sg_Graphics_DrawThickLine = (void (__cdecl *)(color clr, float xPosStart, float yPosStart, float xPosEnd, float yPosEnd, float width)) GetProcAddress( LibraryHandle, "sg_Graphics_DrawThickLine" );
